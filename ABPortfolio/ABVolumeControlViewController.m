//
//  ABVolumeControlViewController.m
//  ABPortfolio
//
...
#import "ABVolumeControlViewController.h"
#import <ABVolumeControl/ABVolumeControl.h>

@interface ABVolumeControlViewController () <ABVolumeControlDelegate>

@end

@implementation ABVolumeControlViewController
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    self.navigationController.navigationBar.backgroundColor = [self colorWithHexString:@"FFFFFF"];
